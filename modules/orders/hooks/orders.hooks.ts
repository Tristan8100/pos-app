...
export function ordersHooks() {
    const { fetchAndSetData, products, search, setSearch, selectedCategory, setSelectedCategory } = useProducts()
    ...
    return {
        ...
        selectedCategory, //from products
        setSelectedCategory, //from products
    }
}